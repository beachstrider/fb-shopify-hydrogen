import Carousel1 from '../../assets/how-it-works/hero_bg.png';
import Carousel2 from '../../assets/how-it-works/hero_bg.png';
import Carousel3 from '../../assets/how-it-works/hero_bg.png';
export function HeroInnerSection() {
  return (
    <section className="h-[420px]  bg-right bg-center relative overflow-hidden bg-no-repeat bg-cover pb-5 bg-image bg-[url('../assets/how-it-works/join_bg.png')]">
