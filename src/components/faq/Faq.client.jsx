...
import {FaqQuestionAndAnswer} from '~/components';
...
const data = [
  {
    question: 'When will my FEASTbox arrive?',
    answer:
      'You choose your delivery date when you order and will receive email confirmation with this information. Plus, you can see it in your account. It is pretty fun to choose a day with your eyes closed though and then be surprised when the box shows up. Keeps life interesting!',
  },
  {
    question: 'How do I prepare the food?',
    answer:
      'Lucky for you, the feastiness is already fully cooked. All you need to do is heat it up! Each sleeve has microwave directions or you can scan the QR code to see oven heating instructions.',
  },
  {
    question: 'What’s in each box?',
    answer:
      ' You choose which cuisine you’re getting and the number of meals in each box (this depends on if you chose a Family Box or Event Box). Each box will always have some sort of entree and side dishes and if you’re really special we’ll pack yours with a little extra love. ',
  },
  {
    question: 'When do I choose my meals?',
    answer:
      ' Each week you can pick your delivery day and choose one of our weekly meals. Variety is the spice of life, but if choice gives you debilitating anxiety, we will send you a special selection automatically. Either way, you’ll be invited to Tasty Town each week. ',
  },
  {
    question: 'Can I skip weeks?',
    answer:
      ' We can’t say your dinner table, family, and taste buds will ever forgive you, but skipping weeks is easy through your personal account. ',
  },
];
