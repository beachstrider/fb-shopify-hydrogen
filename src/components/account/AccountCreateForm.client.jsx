          ...
          <div className="mb-3">
            <input
              className={`mb-1 ${getInputStyleClasses(
                emailError,
              )} w-full  py-3 px-4 text-coolGray-500 leading-tight placeholder-coolGray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-coolGray-200 shadow-xs`}
              id="email"
              name="email"
              type="email"
              autoComplete="email"
