  ...
  return (
    <Link to={`/collections/${handle}`}>
      ...
      >
        ...
        <div className="flex flex-col items-baseline justify-between gap-4 px-6 py-8 sm:px-8 md:px-12 bg-gradient-to-t from-contrast/60 text-primary from-primary/60 text-contrast">
          {heading?.value && (
