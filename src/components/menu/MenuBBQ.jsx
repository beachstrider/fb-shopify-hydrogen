  ...
  return (
    <div className="bg-center lg:p-0 sm-max:p-[12%] md-only:p-[12%] relative min-h-[85vh] bg-[#231F20]">
      <div className="lg:grid  lg:grid-cols-2 md:flex sm:flex flex-wrap h-full">
        ...
        <img className="absolute right-0 top-[-30%] w-auto sm-max:w-[30%] sm-max:top-[-10%]" src={'https://res.cloudinary.com/meals/image/upload/f_auto,q_auto/fb/web/about_us/arrows_down.png'} alt='' />

        <div className="flex flex-col lg:pr-[15%] py-[15%] lg:mb-[50px] relative">
          <h3 className="font-bungee lg:text-[5rem] md:text-[4rem] sm-max:text-[3rem] text-white">BBQ FEAST</h3>
