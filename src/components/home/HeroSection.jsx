            ...
            <div className="md:flex block items-start justify-between h-full">
              <div className="w-full md:w-1/2 relative">
                ...
                <img
                  ...
                  className="absolute object-cover w-[100px] xsm:w-[50px] xsm:right-[12px] xsm:top-[-45px] xsm-only:right-[6px] xsm-only:top-[-40px] max-w-md max-w-xsm h-auto md:top-[-85px] right-0 top-[40px]"
                  alt=""
                />
              </div>
