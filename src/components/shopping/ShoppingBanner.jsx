export function ShoppingBanner({
    ...
    return (
        <div className="w-full px-4 mb-8 md:mb-0 md:w-1/3">
            <div className="relative mb-10" style={{height: '564px'}}><a className="absolute top-1/2 left-0 ml-8 transform translate-1/2" href="#">
                ...
                </svg></a><img className="object-cover w-full h-full" src="https://res.cloudinary.com/meals/image/upload/f_auto,q_auto/fb/web/shop/shop_hero.png" alt="" /><a className="absolute top-1/2 right-0 mr-8 transform translate-1/2" href="#">
                    <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
