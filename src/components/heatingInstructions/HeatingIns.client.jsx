    ...
    <section className=" text-white bg-[#121111]">
      ...
      <div className="font-opensans container mx-auto px-5">
        ...
        <p className="mt-5 text-xl lg:text-2xl md:text-2xl">
          ...
          <br />
          3. Transfer contents into a tinfoil pan and spread out evenly.
          <br />
          4. Cover with a tinfoil lid.
          <br />
          5. Cook for 20 minutes.
          <br />
          6. Remove from oven (with your epic FEASTbox oven mitt), take off lid,
          and stir contents.
          <br />
          7. Replace tinfoil lid and place back in the oven (epic oven mitt
          comes to the rescue once more) for 15-20 minutes or until desired
          temperature is reached.
          <br />
          8. Remove from oven (*cough* oven mitt *cough*) and stir.
          <br />
          9. Cover to keep warm until serving.
        </p>
        ...
        <p className="mt-3 text-xl lg:text-2xl md:text-2xl">
          ...
          <br />
          <br />
          All food is fully cooked ahead of time.
          <br />
          <br />
          BBQ Meat Only - Add 1/8 cup of water or apple juice to the bottom of
          the pan before putting the meat in
          <br />
          <br />
      ...
      <div className="w-auto bg-[#DB9707] py-2"></div>
    </section>
  );
}
